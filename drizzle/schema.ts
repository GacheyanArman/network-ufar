...
export const albumCategory = pgEnum("album_category", [
  "events",
  "clubs",
  "student_life",
  "sports",
...
export const photoModerationStatus = pgEnum("photo_moderation_status", [
  "pending",
  "approved",
  "rejected",
]);
...
export const photo = pgTable(
  "photo",
  {
    ...
    moderationStatus: photoModerationStatus("moderation_status")
      .default("approved")
      .notNull(),
...
export const photoAlbum = pgTable(
  "photo_album",
  {
    id: text().primaryKey().notNull(),
    title: text().notNull(),
...
export const academicCalendar = pgTable(
  ...
  (table) => [
    index("academic_calendar_created_by_idx").using(
      "btree",
      table.createdBy.asc().nullsLast().op("text_ops"),
    ),
    index("academic_calendar_due_date_idx").using(
      "btree",
...
export const photoTag = pgTable(
  ...
  (table) => [
    index("photo_tag_photo_idx").using(
      "btree",
      table.photoId.asc().nullsLast().op("text_ops"),
    ),
    uniqueIndex("photo_tag_photo_user_unique").using(
      "btree",
      table.photoId.asc().nullsLast().op("text_ops"),
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    index("photo_tag_user_idx").using(
      "btree",
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const schedule = pgTable(
  ...
  (table) => [
    index("schedule_created_by_idx").using(
      "btree",
      table.createdBy.asc().nullsLast().op("text_ops"),
    ),
    index("schedule_day_of_week_idx").using(
      "btree",
...
export const groupChat = pgTable(
  ...
  (table) => [
    index("group_chat_course_idx").using(
      "btree",
      table.course.asc().nullsLast().op("text_ops"),
    ),
    index("group_chat_faculty_idx").using(
      "btree",
      table.faculty.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const groupChatMember = pgTable(
  ...
  (table) => [
    uniqueIndex("group_chat_member_unique_idx").using(
      "btree",
      table.groupChatId.asc().nullsLast().op("text_ops"),
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
      columns: [table.groupChatId],
...
export const photoComment = pgTable(
  "photo_comment",
  {
    id: text().primaryKey().notNull(),
    photoId: text("photo_id").notNull(),
  ...
  (table) => [
    index("photo_comment_photo_idx").using(
      "btree",
      table.photoId.asc().nullsLast().op("text_ops"),
    ),
    index("photo_comment_user_idx").using(
      "btree",
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const community = pgTable(
  ...
  (table) => [
    index("community_creator_idx").using(
      "btree",
      table.ownerId.asc().nullsLast().op("text_ops"),
    ),
    index("community_name_idx").using(
      "btree",
...
export const userFollow = pgTable(
  ...
  (table) => [
    uniqueIndex("user_follow_unique_idx").using(
      "btree",
...
export const blockedUser = pgTable(
  ...
  (table) => [
    uniqueIndex("blocked_user_unique_idx").using(
      "btree",
...
export const report = pgTable(
  ...
  (table) => [
    index("report_reporter_idx").using(
      "btree",
...
export const event = pgTable(
  ...
  (table) => [
    index("event_community_idx").using(
      "btree",
      table.communityId.asc().nullsLast().op("text_ops"),
    ),
    uniqueIndex("event_qr_token_unique_idx").using(
      "btree",
      table.qrToken.asc().nullsLast().op("text_ops"),
    ),
    index("event_organizer_idx").using(
      "btree",
      table.organizerId.asc().nullsLast().op("text_ops"),
    ),
    index("event_start_time_idx").using(
      "btree",
...
export const eventRsvp = pgTable(
  ...
  (table) => [
    index("event_rsvp_event_status_idx").using(
      "btree",
      table.eventId.asc().nullsLast().op("text_ops"),
      table.status.asc().nullsLast().op("enum_ops"),
    ),
    uniqueIndex("event_rsvp_unique_idx").using(
      "btree",
      table.eventId.asc().nullsLast().op("text_ops"),
      table.userId.asc().nullsLast().op("text_ops"),
    ),
...
export const eventCoOrganizer = pgTable(
  "event_co_organizer",
  {
    id: text().primaryKey().notNull(),
    eventId: text("event_id").notNull(),
  ...
  (table) => [
    uniqueIndex("event_co_organizer_unique_idx").using(
      "btree",
      table.eventId.asc().nullsLast().op("text_ops"),
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    index("event_co_organizer_event_idx").using(
      "btree",
      table.eventId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
      columns: [table.eventId],
      foreignColumns: [event.id],
      name: "event_co_organizer_event_id_event_id_fk",
    }).onDelete("cascade"),
    foreignKey({
      columns: [table.userId],
      foreignColumns: [user.id],
      name: "event_co_organizer_user_id_user_id_fk",
    }).onDelete("cascade"),
  ],
);

export const eventComment = pgTable(
  "event_comment",
  {
    id: text().primaryKey().notNull(),
    eventId: text("event_id").notNull(),
  ...
  (table) => [
    index("event_comment_event_idx").using(
      "btree",
      table.eventId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
      columns: [table.eventId],
      foreignColumns: [event.id],
      name: "event_comment_event_id_event_id_fk",
    }).onDelete("cascade"),
    foreignKey({
      columns: [table.userId],
      foreignColumns: [user.id],
      name: "event_comment_user_id_user_id_fk",
    }).onDelete("cascade"),
  ],
);
...
export const eventCheckIn = pgTable(
  ...
  (table) => [
    uniqueIndex("event_check_in_unique_idx").using(
      "btree",
      table.eventId.asc().nullsLast().op("text_ops"),
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    index("event_check_in_event_idx").using(
      "btree",
      table.eventId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
      columns: [table.eventId],
      foreignColumns: [event.id],
      name: "event_check_in_event_id_event_id_fk",
    }).onDelete("cascade"),
    foreignKey({
      columns: [table.userId],
      foreignColumns: [user.id],
      name: "event_check_in_user_id_user_id_fk",
    }).onDelete("cascade"),
  ],
);

export const photoLike = pgTable(
  "photo_like",
  {
    id: text().primaryKey().notNull(),
    photoId: text("photo_id").notNull(),
  ...
  (table) => [
    index("photo_like_photo_idx").using(
      "btree",
      table.photoId.asc().nullsLast().op("text_ops"),
    ),
    uniqueIndex("photo_like_photo_user_unique").using(
      "btree",
      table.photoId.asc().nullsLast().op("text_ops"),
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    index("photo_like_user_idx").using(
      "btree",
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const photoSave = pgTable(
  "photo_save",
  {
    id: text().primaryKey().notNull(),
    photoId: text("photo_id").notNull(),
  ...
  (table) => [
    index("photo_save_photo_idx").using(
      "btree",
      table.photoId.asc().nullsLast().op("text_ops"),
    ),
    uniqueIndex("photo_save_photo_user_unique").using(
      "btree",
      table.photoId.asc().nullsLast().op("text_ops"),
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    index("photo_save_user_idx").using(
      "btree",
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
