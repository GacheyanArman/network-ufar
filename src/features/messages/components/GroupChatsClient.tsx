...
import { createGroupChat, joinGroupChat, leaveGroupChat } from "@/features/messages/server/groupChats";
...
type GroupChatsClientProps = {
  allGroupChats: GroupChat[];
  membershipSet: Set<string>;
  currentUserId: string;
};

export default function GroupChatsClient({ allGroupChats, membershipSet, currentUserId }: GroupChatsClientProps) {
    ...
    <>
      ...
      {allGroupChats.length === 0 ? (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px, 1fr))", gap: "16px" }}>
          {allGroupChats.map((group: GroupChat) => {
