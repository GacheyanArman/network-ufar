...
import { createPhotoAlbum, deletePhotoAlbum } from "@/features/photos/server/actions";
    ...
    <>
            ...
            {categories.map((cat) => (
              <button
                ...
                style={{
                  ...
                  background: selectedCategory === cat.value ? "var(--french-blue-soft)" : "var(--bg-card)",
      ...
      {selectedPhotoIndex !== null && (
        <MediaViewer
          ...
          onNavigateAction={setSelectedPhotoIndex}
        />
      )}
    </>
  );
