...
import { user, friendship, photo, photoAlbum, studyMaterial, post, community, message, groupChat, academicCalendar, photoTag, communityMember, postLike, notification, schedule, groupChatMember, photoComment, userFollow, comment, emailVerification, blockedUser, report, event, eventRsvp, photoLike, photoSave } from "./schema";
...
export const groupChatMemberRelations = relations(groupChatMember, ({one}) => ({
	groupChat: one(groupChat, {
